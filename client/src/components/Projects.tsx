...
const PROJECTS = [
  ...
  },
  {
    ...
    image: "https://opengraph.githubassets.com/1/rahul/Agent-based-Ridesharing-Simulation",
        ...
        {!showAll && (
          ...
          >
            <Button 
              ...
              variant="outline"
              className="rounded-full px-8 py-6 border-primary/30 hover:bg-primary/10 text-white gap-2 group transition-all"
            >
              More Projects
